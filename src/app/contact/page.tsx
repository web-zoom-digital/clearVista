        ...
        <section style={{
          ...
          <div className="container" style={{ position: 'relative', zIndex: 1 }}>
            <div style={{ display: 'flex', gap: 8, alignItems: 'center', marginBottom: 32 }}>
              ...
              <span style={{ color: '#F0D16E', fontSize: '0.85rem', fontWeight: 500 }}>Contact</span>
            </div>
            ...
            <h1 className="text-h1" style={{ color: 'white', marginTop: 16, marginBottom: 16 }}>
              ...
              <span style={{ color: '#F0D16E' }}>Project Today</span>
            </h1>
            ...
            <div className="contact-info-grid" style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: 20, marginTop: -60, position: 'relative', zIndex: 10 }}>
              {contactInfo.map(({ icon: Icon, label, value, href, desc }) => (
                <a key={label} href={href} style={{
                  ...
                  onMouseEnter={(e) => { e.currentTarget.style.transform = 'translateY(-4px)'; e.currentTarget.style.boxShadow = '0 20px 50px rgba(200, 160, 92,0.12)'; }}
                ...
                >
                  <div style={{ width: 48, height: 48, borderRadius: 12, background: label === 'WhatsApp' ? 'linear-gradient(135deg, #F0FDF4, #DCFCE7)' : 'linear-gradient(135deg, #EFF6FF, #DBEAFE)', display: 'flex', alignItems: 'center', justifyContent: 'center', marginBottom: 16 }}>
                    {label === 'WhatsApp' ? (
                      ...
                      <Icon size={22} color="#C8A05C" strokeWidth={1.8} />
                    )}
                  </div>
              ...
              <div>
                  ...
                  {[
                    ...
                    <div key={office.city} style={{
                      ...
                      <div style={{ display: 'flex', alignItems: 'flex-start', gap: 12 }}>
                        <MapPin size={18} color="#C8A05C" style={{ marginTop: 2, flexShrink: 0 }} />
                        <div>
                          ...
                          <a href={`tel:${office.phone}`} style={{ color: '#C8A05C', fontSize: '0.85rem', fontWeight: 600, textDecoration: 'none' }}>{office.phone}</a>
                        </div>
                      </div>
                    </div>
                  ))}
                ...
                <div style={{ padding: '24px', background: '#F0F7FF', borderRadius: 12, border: '1px solid #DBEAFE' }}>
                  <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 16 }}>
                    <Clock size={18} color="#C8A05C" />
                    <p style={{ fontFamily: 'Outfit, sans-serif', fontWeight: 700, color: '#C8A05C' }}>Business Hours</p>
                  </div>
                  {[
