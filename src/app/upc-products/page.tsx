...
const allProducts = [
  { id: 'sw', name: 'Sliding Windows', category: 'Windows', price: '₹850/sq.ft onwards', rating: 4.9, reviews: 2341, badge: 'Bestseller', image: '/images/product-window.jpg', features: ['Weather-proof', 'Fly-mesh', 'Double glazing', 'Multi-lock'], href: '/windows#sliding' },
  { id: 'cw', name: 'Casement Windows', category: 'Windows', price: '₹950/sq.ft onwards', rating: 4.8, reviews: 1892, badge: 'Premium', image: '/images/hero-2.jpg', features: ['360° ventilation', 'EPDM gaskets', 'Tilt & turn', 'Custom colors'], href: '/windows#casement' },
  { id: 'fw', name: 'Fixed Windows', category: 'Windows', price: '₹750/sq.ft onwards', rating: 4.7, reviews: 1102, badge: '', image: '/images/hero-3.jpg', features: ['Maximum light', 'No infiltration', 'Custom sizes', 'Triple glazing'], href: '/windows#fixed' },
  { id: 'ttw', name: 'Tilt & Turn Windows', category: 'Windows', price: '₹1100/sq.ft onwards', rating: 4.9, reviews: 876, badge: 'European Style', image: '/images/who-homeowner.jpg', features: ['Dual function', 'Safe ventilation', 'Easy clean', 'High security'], href: '/windows#tilt-turn' },
  { id: 'sd', name: 'Sliding Doors', category: 'Doors', price: '₹1200/sq.ft onwards', rating: 4.9, reviews: 3102, badge: 'Top Rated', image: '/images/hero-1.jpg', features: ['Smooth rollers', 'Fly-mesh', 'Multi-lock', 'Large panels'], href: '/doors#sliding' },
  { id: 'swd', name: 'Swing Doors', category: 'Doors', price: '₹1350/sq.ft onwards', rating: 4.8, reviews: 2213, badge: '', image: '/images/project-2.jpg', features: ['Anti-burglar', 'Weather-strip', 'Custom sizes', '360° swing'], href: '/doors#swing' },
  { id: 'fd', name: 'French Doors', category: 'Doors', price: '₹1500/sq.ft onwards', rating: 4.8, reviews: 987, badge: 'Elegant', image: '/images/project-1.jpg', features: ['Double leaf', 'Floor-to-ceiling', 'Multi-glazing', 'Premium look'], href: '/doors#french' },
  { id: 'ls', name: 'Lift & Slide Doors', category: 'Doors', price: '₹1800/sq.ft onwards', rating: 5.0, reviews: 432, badge: 'Ultra Premium', image: '/images/hero-3.jpg', features: ['6m+ spans', 'Triple glazing', 'Effortless', 'Luxury seal'], href: '/doors#lift-slide' },
  { id: 'bfw', name: 'Bay & Bow Windows', category: 'Specialty', price: 'Custom pricing', rating: 4.9, reviews: 312, badge: 'Architectural', image: '/images/project-2.jpg', features: ['Panoramic view', 'Adds space', 'Custom angles', 'Premium finish'], href: '/windows#bay' },
  { id: 'bf', name: 'Bi-Fold Doors', category: 'Specialty', price: 'Custom pricing', rating: 4.8, reviews: 267, badge: 'Modern', image: '/images/contact-office.jpg', features: ['Full width open', 'Space-saving', 'Multi-panel', 'Smooth fold'], href: '/doors#bi-fold' },
  { id: 'lw', name: 'Louver Windows', category: 'Specialty', price: '₹700/sq.ft onwards', rating: 4.6, reviews: 543, badge: '', image: '/images/project-1.jpg', features: ['Max ventilation', 'Privacy glass', 'Rust-free', 'Low maintenance'], href: '/windows#louver' },
  { id: 'cd', name: 'Casement Doors', category: 'Doors', price: '₹1100/sq.ft onwards', rating: 4.7, reviews: 745, badge: '', image: '/images/hero-2.jpg', features: ['Traditional look', 'Superior seal', 'Custom colors', 'Low threshold'], href: '/doors#casement' },
];
